Shader "Unlit/function_Abs"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            {
                // calculate the absolute value of U, mirror effect if you can image
                float u = abs(i.uv.x - 0.5);
                // calculate the absolute value of V, mirror effect if you can image
